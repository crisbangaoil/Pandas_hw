...
for (var i = 0; i < burritos.length; i++) {
  ...
  if (burritos[i].type === "Breakfast") {
    ...
    }).bindPopup("<h1>" + burritos[i].restuarant + "<h2>" + burritos[i].burrito_name + "</h1> <hr> <h3>overall score: " + burritos[i].overall + "</h3>"));
  }
  else if   
...
L.control.layers(baseMaps, overlayMaps, {
  ...
  // LEGEND
  var legend = L.marker({position: 'bottomright'}, {icon: '<img src="/static/js/legend.png" alt="legend" width="134" height="147">' });
