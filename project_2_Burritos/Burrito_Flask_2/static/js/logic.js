  ...
  if (burritos[i].type === "Breakfast") {
    breakfastmarkers.push(
      L.circle(burritos[i].location, {
        ...
        // Adjust radius
        radius: burritos[i].overall * burritos[i].overall * burritos[i].overall * burritos[i].overall
    }).bindPopup("</h1> <hr> <h3>overall score: " + burritos[i].overall + "</h3>" + burritos[i].full_address + "</h3>"));
  }
  else if   
